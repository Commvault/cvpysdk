...
"""File for operating on a Virtual Server Openshift Instance.

OpenShiftInstance is the only class defined in this file.

OpenShiftInstance: Derived class from VirtualServer  Base class, representing a
                           openshift instance, and to perform operations on that instance

OpenShiftInstance:

    __init__(agent_object,instance_name,instance_id)    --  initialize object of Openshift
                                                            Instance object associated with the
                                                            VirtualServer Instance


    _get_instance_properties()                          --  VirtualServer Instance class method
                                                            overwritten to get Openshift
                                                            Specific instance properties as well

    _set_instance_properties()                          --  Openshift Instance class method
                                                            to set Openshift
...
class OpenShiftInstance(VirtualServerInstance):
    """Class for representing an Openshift instance of the Virtual Server agent."""
    ...
    def __init__(self, agent, instance_name, instance_id=None):
        ...
        self._username = None
        super(OpenShiftInstance, self).__init__(agent, instance_name, instance_id)
    ...
    def _get_instance_properties(self):
        ...
        super(OpenShiftInstance, self)._get_instance_properties()
