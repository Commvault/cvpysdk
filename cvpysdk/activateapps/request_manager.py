...
class Request:
    ...
    def __init__(self, commcell_object, req_name, req_id=None):
        ...
        self._req_approver = None
        self._req_reviewer = None
    ...
    def _get_request_properties(self):
        ...
        if flag:
            if response.json():
                ...
                self._req_approver = response.json().get('approvers')
                self._req_reviewer = response.json().get('reviewers')
