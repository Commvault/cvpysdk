...
HyperVInstance:
	...
	__init__(,backupset_object, subclient_name, subclient_id)    --  initialize object of hyper-v subclient object associated with
                                                                        the VirtualServer subclient

    disk_restore()                                               -- Perform Disk Restore on Hyper-V Subclient
...
class HyperVVirtualServerSubclient(VirtualServerSubclient):
    """Derived class from VirtualServerSubclient  Base class, representing a Hyper-V  virtual server subclient,
    ...
    def __init__(self,backupset_object, subclient_name, subclient_id=None):
        """Initialize the Instance object for the given Virtual Server instance.
            ...
            Args:
                class_object (backupset_object, subclient_name, subclient_id)  --  instance of the backupset class, subclient name, subclient id

		"""
        super(HyperVVirtualServerSubclient,self).__init__(backupset_object, subclient_name, subclient_id)
    ...
    def disk_restore(self,
        ...
        """Restores the disk specified in the input paths list to the same location
            ...
            Args:
                ...
                copy_preceedence    (int)   -- SP copy precedence from which browse has to be performed
        ...
        if (not (convert_to is None)):
            ...
            if(isinstance(_disk_extn,list)):
                ...
                _disk_restore_option["destination_vendor"],_disk_restore_option["destination_disktype"] = self._get_conversion_disk_Type(_disk_extn,convert_to)
        ...
        if (not(diskName is None)):
            if diskName in disk_list:
